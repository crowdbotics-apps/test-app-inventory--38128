...
## Project Structure
    ...
    ├── test_app_inventory__38128  # Django project configurations
...
1. Clone this repo and `cd test_app_inventory__38128`
...
2. Clone this repo and `cd test_app_inventory__38128`
